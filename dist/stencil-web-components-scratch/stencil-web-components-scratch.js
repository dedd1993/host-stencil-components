...
if (!win.__stencil_cssshim && needsShim()) {
    ...
    var regex = /\/stencil-web-components-scratch(\.esm)?\.js($|\?|#)/;
    var scriptElm = currentScript || Array.from(doc.querySelectorAll('script')).find(function(s) {
      return regex.test(s.src) || s.getAttribute('data-stencil-namespace') === "stencil-web-components-scratch";
    });

    var resourcesUrl = scriptElm ? scriptElm.getAttribute('data-resources-url') || scriptElm.src : '';
    var start = function() {
      var url = new URL('./p-1acd7ee7.system.js', resourcesUrl);
