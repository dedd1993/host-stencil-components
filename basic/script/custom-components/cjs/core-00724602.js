...
const NAMESPACE = 'stencil-web-components-scratch';
...
const patchBrowser = async () => {
    ...
    // @ts-ignore
    const importMeta = (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('core-00724602.js', document.baseURI).href));
